...
int LemonSqueezyCompressorVSTAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int LemonSqueezyCompressorVSTAudioProcessor::getCurrentProgram()
{
    return 0;
}

void LemonSqueezyCompressorVSTAudioProcessor::setCurrentProgram (int index)
{
}

const juce::String LemonSqueezyCompressorVSTAudioProcessor::getProgramName (int index)
{
    return {};
}

void LemonSqueezyCompressorVSTAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}
...
void LemonSqueezyCompressorVSTAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
//==============================================================================
bool LemonSqueezyCompressorVSTAudioProcessor::hasEditor() const
{
